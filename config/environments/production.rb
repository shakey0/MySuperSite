...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "my_super_site_production"
  ...
  config.hosts = [
    "shakey0.co.uk",     # Allow requests from shakey0.co.uk
    /.*\.shakey0\.co.uk/ # Allow requests from subdomains like `www.shakey0.co.uk`
  ]
  ...
  config.action_mailer.default_url_options = { host: 'shakey0.co.uk' }
end
